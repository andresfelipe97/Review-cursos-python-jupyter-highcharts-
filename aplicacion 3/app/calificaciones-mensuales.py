...
data = pandas.read_csv("/mnt/c/Users/andre/OneDrive/Escritorio/DATA_ENGINEER/Proyectos-udemy-py/aplicacion 3/reviews-graficos/reviews.csv", parse_dates=['Timestamp'])
